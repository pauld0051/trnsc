const recipes = {
  ...
  cheese_scrolls: {
    ...
    category: ["snacks", "vegetarian", "quick_and_easy", "gluten_free"],
  ...
  empanadas: {
    ...
    img_src: "/public/images/recipes/empanadas/empanadas.jpg",
    description:
      "These crispy, golden empanadas use a lupin flour dough for a low-carb twist. Perfectly keto-friendly and versatile for both savoury and sweet fillings.",
    prep_time: "25 mins",
    cook_time: "15 mins",
    total_time: "40 mins",
    ...
    ingredients: [
      ...
      "2 tablespoons unsalted butter, melted",
      "1–2 tablespoons water (if needed)",
      "<strong>For the Fillings:</strong>",
      "<em>Spinach and Feta:</em> 1 cup (30 g) fresh spinach (chopped), ½ cup (75 g) feta cheese (crumbled), 1 garlic clove (minced), 1 tablespoon olive oil <a href='https://amzn.to/4gVpL0c' target='_blank'>(Amazon EU/UK)</a> or <a href='https://amzn.to/47SOaPT' target='_blank'>(Amazon US/Can)</a>.",
      "<em>Chicken and Cheese:</em> 1 cup (150 g) shredded cooked chicken, ½ cup (75 g) grated mozzarella or cheddar, 1 tablespoon taco seasoning, 1 tablespoon olive oil <a href='https://amzn.to/4gVpL0c' target='_blank'>(Amazon EU/UK)</a> or <a href='https://amzn.to/47SOaPT' target='_blank'>(Amazon US/Can)</a>.",
      "<em>Mushroom and Ricotta:</em> 1 cup (100 g) mushrooms (chopped), ½ cup (100 g) ricotta, 1 tablespoon fresh thyme or rosemary, salt and pepper to taste, 1 tablespoon olive oil <a href='https://amzn.to/4gVpL0c' target='_blank'>(Amazon EU/UK)</a> or <a href='https://amzn.to/47SOaPT' target='_blank'>(Amazon US/Can)</a>.",
    ],
    method: [
      "<strong>Prepare the Dough:</strong>",
      "In a mixing bowl, whisk together lupin flour, almond flour, xanthan gum, baking powder, and salt.",
      "In a separate bowl, mix Greek yoghurt, eggs, and melted butter until smooth.",
      "Gradually mix wet ingredients into dry ingredients to form a dough. Knead lightly until combined. If the dough feels dry, add 1–2 tablespoons of water, one at a time.",
      "Let the dough rest for 5–10 minutes to allow the xanthan gum to hydrate.",
      "<strong>Roll Out the Dough:</strong>",
      "Place the dough between two sheets of parchment paper. Roll it out into a rectangle about ½ cm thick.",
      "<strong>Prepare Your Filling:</strong>",
      "<em>Spinach and Feta:</em> Heat olive oil in a pan, sauté garlic for 1 minute, add spinach, and cook until wilted. Remove from heat and mix in crumbled feta.",
      "<em>Chicken and Cheese:</em> Mix shredded chicken with cheese, taco seasoning, and olive oil in a bowl.",
      "<em>Mushroom and Ricotta:</em> Sauté mushrooms in olive oil with salt and pepper until golden. Mix with ricotta and herbs.",
      "<strong>Assemble the Empanadas:</strong>",
      "Cut the dough into circles (10 cm diameter). Place 1–2 tablespoons of your chosen filling in the centre.",
      "Fold the dough in half and seal the edges with a fork. Brush the tops with olive oil for a golden finish.",
      "<strong>Bake:</strong>",
      "Place empanadas on a parchment-lined baking sheet. Bake at 180°C (350°F) for 12–15 minutes or until golden brown.",
    ],
    tips: [
      "Brush the tops with olive oil for extra crispiness.",
      "Try sweet fillings like cream cheese and berries for a dessert version.",
      "Keep the dough covered with a damp towel to prevent drying while assembling.",
      "Reheat leftovers in a low oven or air fryer to maintain crispiness.",
    ],
    nutrition: {
      calories: "150 kcal",
      carbs: "6g",
