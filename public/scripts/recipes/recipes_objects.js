const recipes = {
  ...
  almond_flour_buns: {
    ...
    ingredients: [
      ...
      "1 tablespoon olive oil or avocado oil (plus extra for cooking) <a href='https://amzn.to/4gVpL0c' target='_blank'>(Amazon EU/UK)</a> or <a href='https://amzn.to/47SOaPT' target='_blank'>(Amazon US/Can)</a>",
    ],
    method: [
