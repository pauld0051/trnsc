const recipes = {
  ...
  chicken_pad_thai: {
    ...
    ingredients: [
      ...
      "200g shirataki noodles (or bean noodles, cooked), rinsed and drained",
    ...
    method: [
      ...
      "4. Add the Noodles: Add the shirataki noodles and continue stir-frying with the vegetables for another 2-3 minutes. The noodles should be heated through and well-mixed with the vegetables.",
      "4.1 If you're using bean noodles, which are a good source of fibre and protein, then cook them to instructions and add them in the same manner",
      "5. Scramble the Eggs: Push the noodle-vegetable mixture to one side of the pan. Pour the beaten eggs into the other side and scramble them until cooked. Once done, mix them into the noodles and vegetables.",
      "6. Combine and Season: Return the cooked chicken to the pan, pour the family-friendly Pad Thai sauce over everything, and toss to coat well. Remove a portion for the family, then add the spicy sauce you prepared for yourself, tossing everything until well combined and heated through.",
      "7. Add Final Ingredients: Add the bean sprouts and most of the spring onions, tossing everything together. Cook for another minute until the bean sprouts are slightly wilted.",
      "8. Garnish and Serve: Remove from heat and serve hot, garnished with chopped peanuts, fresh coriander, and the remaining spring onions. Add a lime wedge on the side for extra zing.",
    ],
    tips: [
